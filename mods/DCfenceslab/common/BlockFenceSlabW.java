...
import mods.DCfenceslab.client.RenderFenceSlabW;
import mods.DCfenceslab.common.*;

public class BlockFenceSlabW extends Block{
	
	public BlockFenceSlabW (int blockid)
	{
    ...
    {
		int i = par2 & 3;
		return Block.planks.getIcon(1, i);
    }
